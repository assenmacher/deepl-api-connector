...
final class DeeplFileRequestHandler extends AbstractDeeplRequestHandler implements DeeplRequestHandlerInterface
{
    const API_ENDPOINT = '/v2/document/%s/result';
